...
class DataGrid
{
    ...
    public static function dataGridTemplate($title, $dbTable, $countResult, $columnResult, $delete, $edit, $data, $theme) {
        ...
        $html .= '<thead class="sticky top-0 dark:text-gray-400 border-collapse">';
        $html .= '<tr>';
        ...
        if ($delete) {
            ...
            $html .= '<form action="/export-tsv" method="post" target="_blank">
