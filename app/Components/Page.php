...
class Page
{
    public static function head(string $title, string $description, array $keywords, string $thumbimage)
    {
        $html = '';
    ...
    public static function header($usernameArray, $menuArray, $isAdmin, $theme)
    {
        $html = '';
        $html .= '<header>';
            $html .=  self::menu($menuArray, $theme, $usernameArray, $isAdmin);
        $html .= '</header>';
        return $html;
    }
    public static function menu($array, $theme, $usernameArray, $isAdmin)
    {
        if (empty($array)) {
            return;
        }
    ...
    public static function footer($theme)
    {
        $html = '';
