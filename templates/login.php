...
">
        ...
        <!--
            <div class="mt-5">
            <form action="/local-login-process" autoComplete="off" method="post">
                <div class="flex flex-col mb-2">
                    <div class="flex relative ">
                        ...
                        <input type="text" id="sign-in-email" name="username" class="rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-<?= COLOR_SCHEME ?>
-600 focus:border-transparent" placeholder="Your email" required />
                        </div>
                    </div>
                    <div class="flex flex-col mb-6">
                        <div class="flex relative ">
                            ...
                            <input type="password" id="sign-in-email" name="password" class="rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-<?= COLOR_SCHEME ?>
-600 focus:border-transparent" placeholder="Your password" required />
                            </div>
                        </div>
                        </div>
