...
class Cookies
{
    public static function set(string $name, string $value, int $expiration = 86400, string $path = '/', string $domain = '', bool $secure = false, bool $httponly = true, string $samesite = 'Lax')
    {
