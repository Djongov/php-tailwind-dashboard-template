...
(function( factory ) {
	...
	$.extend( DataTable.ext.classes, {
		...
		info: {
			container: 'dt-info text-sm mt-2'
		},
		layout: {
			row: 'dt-layout-row',
			cell: 'dt-layout-cell',
			tableRow: 'dt-layout-table max-h-[44rem] overflow-y-auto',
			tableCell: '',
		...
		search: {
			container: 'dt-search text-sm',
			input: `dt-input w-max-md p-2 my-2 ml-2 text-sm bg-gray-100 appearance-none border-2 border-gray-200 rounded-lg text-gray-700 leading-tight focus:outline-none focus:bg-gray-50 focus:border-${theme}-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-${theme}-500 dark:focus:border-${theme}-500 brainpower`
		},
		table: 'dataTable',	
		tbody: {
			cell: '',
		...
		paging: {
			active: `current border-2 border-gray-600 dark:border-gray-400 text-gray-100 bg-${theme}-500 focus:bg-${theme}-600 dark:bg-${theme}-600 dark:focus:bg-${theme}-300 focus:text-white`,
			button: `dt-paging-button my-2 p-2 text-sm text-gray-700 hover:text-gray-900 dark:text-gray-100 dark:hover:text-gray-200 focus:text-gray-100 bg-gray-100 hover:bg-${theme}-500 focus:bg-${theme}-600 dark:bg-gray-900 dark:hover:bg-${theme}-500 dark:focus:bg-${theme}-600 border border-gray-700 dark:border-gray-400 dark:hover:border-gray-300`,
			container: 'dt-paging my-2',
			disabled: 'disabled',
		}
	});
