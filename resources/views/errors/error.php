...
use Core\HttpErrorHandler;

function handleHTTPError($code, $title, $message, $theme)
{
    $html = '';
...
echo HttpErrorHandler::render(404, 'Not found', 'The page you are looking for is not there.... or you are just trying random stuff...', $theme);
