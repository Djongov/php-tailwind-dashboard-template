...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="/" class="flex items-center">
                <?=LOGO?>
                <span class="ml-2 self-center text-lg font-semibold whitespace-nowrap dark:text-white"><?= SITE_TITLE ?></span>
            </a>
        </div>
        <div class="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-4">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Report Issues</h2>
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="/submit-bug" class="hover:underline">Submit Bug/Issue</a>
                    </li>
                    <li class="mb-4">
                        <a href="/whats-new" class="hover:underline">What's new</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <a href="https://www.sunwellsolutions.com/" class="hover:underline" target="_blank">Company</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://www.linkedin.com/company/sunwell-solutions-ltd/" class="hover:underline" target="_blank">LinkedIn</a>
                    </li>
                    <li>
                        <a href="https://twitter.com/Sunwell_LTD" class="hover:underline" target="_blank">Twitter</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div class="sm:my-2 md:my-4 my-6 dark:text-gray-400 text-gray-500 text-sm ">
        <span class="sm:text-center">© <?= date("Y") ?> <a href="<?= COMPANY_URL ?>" class="underline" target="_blank"><?= COMPANY_NAME ?></a>. All Rights Reserved.</span>
