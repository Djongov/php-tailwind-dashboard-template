...
/* Docs */
$router->get('/docs', '/docs/index.php');
...
foreach ($files as $file) {
    $router->get('/docs/' . $file, '/docs/index.php');
}
...
$router->post('/api/delete-user', '/api/delete-user.php');

$router->post('/api/local-login-process', '/api/local-login-process.php');
