...
if (isset($_POST['id_token'])) {
    ...
    if (AzureAD::checkJWTToken($_POST['id_token'])) {
        ...
        setcookie('auth_cookie', $_POST['id_token'], AzureAD::parseJWTTokenPayLoad($_POST['id_token'])['exp'] + 86400, '/', str_replace(strstr($_SERVER['HTTP_HOST'], ':'), '', $_SERVER['HTTP_HOST']), $secure, true);
