...
define("UPDATE_DATE", date('Y-m-d'));

?>

<div class="container ml-4 p-4">
    <h1 class="my-4 font-bold text-4xl">Terms &amp; Conditions</h1>
    <p>Updated at <?= UPDATE_DATE ?></p>

    <h1 class="my-4 font-bold text-2xl">General Terms</h1>
    <p class="py-8">By accessing and placing an order with us, you confirm that you are in agreement with and bound by the terms of service contained in the Terms &amp; Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and.
        <br>
        <br>
    ...
    <h1 class="font-bold text-2xl mt-4">License</h1>
    <p class="py-6"><strong><?= SITE_TITLE ?>
        </strong> grants you a revocable, non-exclusive, non- transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement.
        <br>
        <br>
        These Terms &amp; Conditions are a contract between you and <span class="font-semibold"><?= SITE_TITLE ?>
        </span> (referred to in these Terms &amp; Conditions as "<span class="font-semibold"><?= SITE_TITLE ?>
        </span>", "us", "we" or "our"), the provider of the <span class="font-semibold"><?= SITE_TITLE ?>
        </span> website and the services accessible from the <span class="font-semibold"><?= SITE_TITLE ?>
        </span> website (which are collectively referred to in these Terms &amp; Conditions as the "<span class="font-semibold"><?= SITE_TITLE ?>
        </span> Service").
        <br>
        <br>
    ...
    <h1 class="font-bold text-2xl mt-4">Definitions and key terms</h1>
    <p class="py-8">For this Terms &amp; Conditions:</p>
    <ul class="ml-6">
        <li class="list-disc">
        ...
        <li class="list-disc">
            <strong>Company:</strong> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to <strong><?= COMPANY_NAME ?></strong>, <strong><?= COMPANY_COUNTRY ?>, <?= COMPANY_ADDRESS ?></strong> that is responsible for your information under this Privacy Policy.
        </li>
        <li class="list-disc">
            <strong>Country:</strong> where <span class="font-semibold"><?= SITE_TITLE ?>
                or the owners/founders of <span class="font-semibold"><?= SITE_TITLE ?>
                    are based, in this case is <a><?= COMPANY_COUNTRY ?></a>.
        </li>
        <li class="list-disc">
            <strong>Customer:</strong> refers to the company, organization or person that signs up to use the <span class="font-semibold"><?= SITE_TITLE ?>
                Service to manage the relationships with your consumers or service users.
        </li>
        <li class="list-disc">
            <strong>Device:</strong> any internet connected device such as a phone, tablet, computer or any other device that can be used to visit <span class="font-semibold"><?= SITE_TITLE ?>
        ...
        <li class="list-disc">
            <strong>Personnel:</strong> refers to those individuals who are employed by <span class="font-semibold"><?= SITE_TITLE ?>
        ...
        <li class="list-disc">
            <strong>Service:</strong> refers to the service provided by <span class="font-semibold"><?= SITE_TITLE ?>
        ...
        <li class="list-disc">
            <strong>Website:</strong> <span class="font-semibold"><?= SITE_TITLE ?>
                ’s site, which can be accessed via this URL: <a class="underline text-<?= $theme ?>-500 hover:text-<?= $theme ?>-700" href="<?= 'https://' . $_SERVER['HTTP_HOST'] ?>
"><?= 'https://' . $_SERVER['HTTP_HOST'] ?>
                </a>
        </li>
        <li class="list-disc">
            <strong>You:</strong> a person or entity that is registered with <span class="font-semibold"><?= SITE_TITLE ?>
                to use the Services.
        </li>
    </ul>
    <h1 class="font-bold text-2xl mt-4">Restrictions</h1>
    <p class="py-6">You agree not to, and you will not permit others to:</p>
    <ul class="ml-6">
        <li class="list-disc">
    ...
    <h1 class="font-bold text-2xl mt-4">Return and Refund Policy</h1>
    <p class="py-6">
        We are not charging for the service so the way to return or refund the service is by deleting your account
    </p>

    <h1 class="font-bold text-2xl mt-4">Your Suggestions</h1>
    <p class="py-6">
    ...
    <h1 class="font-bold text-2xl mt-4">Your Consent</h1>
    <p class="py-6">
    ...
    <h1 class="font-bold text-2xl mt-4">Waiver</h1>
    <p class="py-6">Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Agreement shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute waiver of any subsequent breach.
        <br>
        <br>
        No failure to exercise, and no delay in exercising, on the part of either party, any right or any power under this Agreement shall operate as a waiver of that right or power. Nor shall any single or partial exercise of any right or power under this Agreement preclude further exercise of that or any other right granted herein. In the event of a conflict between this Agreement and any applicable purchase or other terms, the terms of this Agreement shall govern.
    </p>
    <h1 class="font-bold text-2xl mt-4">Amendments to this Agreement</h1>
    ...
    <h1 class="text-2xl font-bold mt-4">Contact Us</h1>
    <p class="pt-6">Don't hesitate to contact us if you have any questions.</p>
    <ul class="ml-6">
        <li class="list-disc">Via Email: <a class="underline text-<?= $theme ?>-500 hover:text-<?= $theme ?>-700" href="mailto:<?= COMPANY_EMAIL ?>"><?= COMPANY_EMAIL ?></a></li>
        <li class="list-disc">Via Phone Number: <a class="underline text-<?= $theme ?>-500 hover:text-<?= $theme ?>-700" href="tel:<?= COMPANY_PHONE ?>"><?= COMPANY_PHONE ?></a></li>
    </ul>
</div>
